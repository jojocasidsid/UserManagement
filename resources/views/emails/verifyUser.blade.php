                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <h2>You are just one step away. {{$user['name']}}</h2>

                        <h5>Your registered email-id is {{$user['email']}} , Please click on the below link to verify your email account</h5>

                        <p>Your temporary password is <b>{{$password}}</b></p>
                        <br>

                        <p>Your activation code is <b>{{$fourdigitrandom}}</b></p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="{{url('user/verify', $user->verifyUser->token)}}" target="_blank">confirm email</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
